...
public class XBinder implements IBinder {
    ...
    private static long serviceExecuteTime = 1471;  // 本地执行所需时间，单位ms
    private static long cloudExecuteTime = 447;     // 远程执行所需时间，单位ms
    private static long totalCloudExecuteTime = 2033 * 2 - cloudExecuteTime;   // 云端执行所需总时间，单位ms
